...
st.markdown(
    ...
    <style>
      ...
      a.agent-card {{
        ...
        padding:16px 14px; box-shadow:0 6px 18px rgba(0,0,0,.06);
        transition: transform .12s ease, box-shadow .12s ease, border-color .12s ease;
        height:184px; text-align:center; margin-bottom: 0.6rem;
      }}
      ...
      .agent-title {{ font-weight:800; font-size:15px; margin:6px 0 2px 0; }}
...
AGENTS = [
    ...
    {"name": "Agent6",  "emoji": "👤", "color": "#EF4444", "desc": "Agent 준비중입니다.", "url": "#"},
    {"name": "Agent7",  "emoji": "🧠", "color": "#2563EB", "desc": "Agent 준비중입니다.", "url": "#"},
    {"name": "Agent8",  "emoji": "🌿", "color": "#22C55E", "desc": "Agent 준비중입니다.", "url": "#"},
    {"name": "Agent9",  "emoji": "🧭", "color": "#F43F5E", "desc": "Agent 준비중입니다.", "url": "#"},
    {"name": "Agent10", "emoji": "💬", "color": "#6366F1", "desc": "Agent 준비중입니다.", "url": "#"},
    {"name": "Agent11", "emoji": "🌐", "color": "#0EA5E9", "desc": "Agent 준비중입니다.", "url": "#"},
    {"name": "Agent12", "emoji": "🧪", "color": "#FB923C", "desc": "Agent 준비중입니다.", "url": "#"},
]
...
st.markdown('<div class="divider-min">//</div>', unsafe_allow_html=True)
